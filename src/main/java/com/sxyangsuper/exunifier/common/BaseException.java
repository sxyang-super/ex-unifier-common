...
public class BaseException extends RuntimeException {
    ...
    protected static <T extends BaseException> T of(
    ...
    protected static <T extends BaseException> T ofWithCause(
        final Supplier<T> exceptionSupplier,
        final IExceptionEnum responseEnum,
    ...
    protected static <T extends BaseException> T ofWithData(
        final Supplier<T> exceptionSupplier,
        final IExceptionEnum responseEnum,
        final Object data,
        final Object... args
    ...
    protected static <T extends BaseException> T ofWithCauseAndData(
        final Supplier<T> exceptionSupplier,
        final IExceptionEnum responseEnum,
        final Throwable cause,
        final Object data,
